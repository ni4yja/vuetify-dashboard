  ...
  <v-app id="inspire">
    ...
    <v-container>
      <v-app-bar color="rgba(0,0,0,0)" flat>
        ...
        ></v-select>
        <span text color="#878194">AAE IdeaPro</span>
      ...
      <v-row>
        <v-col cols="12" sm="8">
                ...
                <v-list-item three-line>
                  <v-list-item-content>
                    <v-list-item-title class="text-h4 mb-1"
                      >Hey AAE IdeaPro.</v-list-item-title
                    >
                    <v-list-item-subtitle>
                      Welcome back AAA IdeaPro. We are glad here<br />
                      Inspire the best work in people. Enabling them to achieve
                    </v-list-item-subtitle>
                    <v-list-item-subtitle> their goals.</v-list-item-subtitle>
                  </v-list-item-content>
                </v-list-item>
                <v-card-actions>
          ...
          <v-row class="mt-n5">
            <v-col cols="12" sm="4">
              <v-card class="rounded-xl ml-4" color="grey lighten-3" flat>
                ...
                <v-card-text>
                  A prototyping is an early <br />sample, model release of a
                  product build to text a..
                </v-card-text>
            ...
            <v-col cols="12" sm="4">
              <v-card class="rounded-xl" color="black" dark elevation="10">
                <v-card-title>
                  <span class="text-h6 font-weight-light">Typography</span>
                </v-card-title>
                <v-card-text class="">
                  In essence, typography is the artof arranging letters and text
                  in away that..
                </v-card-text>
                <v-card-actions class="mt-n7">
                  <v-list-item class="">
            ...
            <v-col cols="12" sm="4">
              <v-card class="rounded-xl mr-4" color="grey lighten-3" flat>
                ...
                <v-card-text class="">
                  The best way to use a scheme like this is to use one color as
                  the primary..
                </v-card-text>
                <v-card-actions class="mt-n7">
                  <v-list-item class="">
          ...
          <v-card class="mx-4 rounded-xl pa-6 mt-2" color="grey lighten-3">
        ...
        <v-col cols="12" sm="4">
          <v-card class="rounded-xl pa-4" color="grey lighten-3" flat>
            ...
            <v-app-bar color="rgba(0,0,0,0)" tile class="mt-3">
              ...
              <strong class="subtitle black--text ml-2">
                Claps this week <span class="caption"><br />1.5k</span>
              </strong>
              <v-spacer></v-spacer>
              <v-icon color="grey" class="ml-2"
                >fas fa-chevron-circle-right</v-icon
            ...
            <v-app-bar color="rgba(0,0,0,0)" tile class="mt-3">
              ...
              <strong class="subtitle black--text ml-2">
                New followers <span class="caption"><br />+100</span>
              </strong>
              <v-spacer></v-spacer>
              <v-icon color="grey" class="ml-2"
                >fas fa-chevron-circle-right</v-icon
            ...
            <v-card color="white" class="rounded-xl mx-4 pa-10" flat>
              <div class="text-center">
                <span
                  >Buy <strong>Pro Account</strong> to Explore <br />
                  Premium Features</span
                >
                <v-btn class="mt-5" dark color="black">Purchase Now</v-btn>
              </div>
            </v-card>
          </v-card>
        </v-col>
